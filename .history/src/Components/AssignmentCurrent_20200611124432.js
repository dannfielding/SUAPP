                    ...
                    {[1].map(item => {
                        return (
                            <AccordionItem title={` SWD600 - AE${item}`}>
                                    ...
                                    <AssignmentParagraph>Deadline: 21/05/2019</AssignmentParagraph>
                                ...
                                <AssignmentParagraph> - Outline the project plan<Checkbox type="checkbox" checked></Checkbox></AssignmentParagraph>
                                ...
                                <AssignmentParagraph> - Create a poster of all the responses<Checkbox type="checkbox"></Checkbox></AssignmentParagraph>
                    ...
                    return (
                        <AccordionItem title={` SWD600 - AE${item}`}>
                            <div>
                                ...
                                <AssignmentParagraph>Deadline: 11/06/2019</AssignmentParagraph>
                                <AssignmentHeading>Brief:</AssignmentHeading>
                                <AssignmentParagraph>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin et tellus non lorem pellentesque consequat ac sit amet erat. Donec hendrerit ante sapien, facilisis lacinia velit volutpat sit amet. Pellentesque sem libero, porttitor in libero quis, scelerisque efficitur lectus. Aliquam venenatis ut augue eget interdum. Ut euismod placerat dolor in imperdiet. Vestibulum at maximus dolor. Nam molestie mattis scelerisque. Mauris imperdiet risus sit amet enim tempus vulputate. Curabitur nec dapibus dolor, eget venenatis risus.</AssignmentParagraph>
                                <AssignmentHeading>Progress:</AssignmentHeading>
                                <OuterBar><InnerBar></InnerBar></OuterBar>
                                <AssignmentHeading>Tasks:</AssignmentHeading>
                                <AssignmentParagraph> - Plan prototype<Checkbox type="checkbox" checked></Checkbox></AssignmentParagraph>
                                <AssignmentParagraph> - Create a prototype<Checkbox type="checkbox" checked></Checkbox></AssignmentParagraph>
                                <AssignmentParagraph> - Get users to test prototype<Checkbox type="checkbox"></Checkbox></AssignmentParagraph>
                                <AssignmentParagraph> - Write 2000<Checkbox type="checkbox"></Checkbox></AssignmentParagraph>
                            </div>
                        </AccordionItem>
                    );
                })}
                    ...
                    return (
                        <AccordionItem title={` CDA600 - AE${item}`}>
                            <div>
                                ...
                                <AssignmentParagraph>Deadline: 18/06/2019</AssignmentParagraph>
                                <AssignmentHeading>Brief:</AssignmentHeading>
                                <AssignmentParagraph>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin et tellus non lorem pellentesque consequat ac sit amet erat. Donec hendrerit ante sapien, facilisis lacinia velit volutpat sit amet. Pellentesque sem libero, porttitor in libero quis, scelerisque efficitur lectus. Aliquam venenatis ut augue eget interdum. Ut euismod placerat dolor in imperdiet. Vestibulum at maximus dolor. Nam molestie mattis scelerisque. Mauris imperdiet risus sit amet enim tempus vulputate. Curabitur nec dapibus dolor, eget venenatis risus.</AssignmentParagraph>
                                <AssignmentHeading>Progress:</AssignmentHeading>
                                <OuterBar><InnerBar></InnerBar></OuterBar>
