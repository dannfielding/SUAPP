                    ...
                    return (
                        <AccordionItem title={` CDA600 - AE${item}`}>
                            <div>
                                ...
                                <AssignmentParagraph> - Create Medium-Fidelity Wireframes<Checkbox type="checkbox"></Checkbox></AssignmentParagraph>
                                <AssignmentParagraph> - Create Lo-Fidelity Wireframes<Checkbox type="checkbox"></Checkbox></AssignmentParagraph>
                                <AssignmentParagraph> - <Checkbox type="checkbox"></Checkbox></AssignmentParagraph>
                                    </div>
                        </AccordionItem>
                    );
                })}
