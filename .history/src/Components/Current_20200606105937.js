    ...
    <li>
        ...
        <CollapsiblePanel>
            <div class="collapse-inner">
                <ol>
                    <MarginLi>Click <strong>Upload an image</strong>.</CollapsibleLi>
                    <MarginLi>Click <strong>Choose file</strong>.</CollapsibleLi>
                    <MarginLi>Select the image from your computer.</CollapsibleLi>
                </ol>
            </div>
        </CollapsiblePanel>
        </li>
